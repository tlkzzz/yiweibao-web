...
// 获取列表数据
    getList = () => {
        ...
        actions.getGrcode(this.param, (json) => {
...
// 分页事件
 ...
 const columns  = [{
            ...
            },
            {
                ...
                key: 'sourcetype',
                sorter: true,
                  render:val => <span>{val=='asset'?'设备':'商品'}</span>
            },
            {
                title: '设备/商品名称',
                dataIndex: 'name',
        ...
        return (
             ...
             <div className="main-nav clearfix">
                        ...
                        <Link to="/main/settings/code" activeClassName="active">二维码管理</Link>
                    ...
                    <div>
                        <div className="top-bar clearfix  eam-card ip-main-commonMargin">
                                ...
                                <div className="list-tools-right pull-right">
                                    ...
                                    />
                                    <Button type="primary" size="large" onClick={() => {this.jumpToTabPage(1,2)}}>新建</Button>
                                </div>
                            </div>
