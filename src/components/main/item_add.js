...
class ItemAddComponentFormComponent extends React.Component {
    constructor(props) {
        super(props);
...
const ItemAddComponent = Form.create()(ItemAddComponentFormComponent);
...
export default connect(mapStateToProps, buildActionDispatcher)(ItemAddComponent);
