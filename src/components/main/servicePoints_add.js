...
class ServicePointsAddFormComponent extends React.Component {
    constructor(props) {
        super(props);
...
const ServicePointsAddComponent = Form.create()(ServicePointsAddFormComponent);
...
export default connect(mapStateToProps, buildActionDispatcher)(ServicePointsAddComponent);
