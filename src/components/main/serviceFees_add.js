...
class ServiceFeesAddFormComponent extends React.Component {
    constructor(props) {
        super(props);
...
const ServiceFeesAddComponent = Form.create()(ServiceFeesAddFormComponent);
...
export default connect(mapStateToProps, buildActionDispatcher)(ServiceFeesAddComponent);
