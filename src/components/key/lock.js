        ...
        this.columns = [
            {
                ...
                render: (text, record, key) => {
                    return (
                        <p><Link className="order-number" to="/key/lock/lock_detail">{text ? text : '-'}</Link></p>
                    )
                }
            },
            {
                ...
                <div>
                    <div className="top-bar clearfix">
                        ...
                        <div className="list-tools-right pull-right">
                            ...
                            <Button type="primary" size="large" ><Link activeClassName="active" to="/key/lock/lock_detail">新建</Link></Button>
                        </div>
                    </div>
...
export default connect(mapStateToProps, buildActionDispatcher)(LockComponent);
