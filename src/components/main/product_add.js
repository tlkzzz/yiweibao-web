...
class ProductAddFormComponent extends React.Component {
    constructor(props) {
        super(props);
...
const ProductAddComponent = Form.create()(ProductAddFormComponent);
...
export default connect(mapStateToProps, buildActionDispatcher)(ProductAddComponent);
