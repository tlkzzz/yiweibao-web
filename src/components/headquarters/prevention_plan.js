...
class MPTabOneComponent extends React.Component {
    ...
    componentDidUpdate () {
        ...
        if (!state.getFormValues) {
            ...
            this.formValuesArr[3] = {
                ...
                weekFrequency: checkedValues ? checkedValues.join(',') : checkedValues,
            };
    ...
    tabClick = (key) => {
        const { location } = this.props;
        const isAddMaintenancePlan = location.query.add_maintenance_Plan;
        browserHistory.push(`/headquarters/work_plan/${key}${isAddMaintenancePlan ? '?add_maintenance_Plan=1' : ''}`);
    }
    checkboxChange = (e) => {
        this.setState({
            ...
            <div className="eam-tab-page">
                <div className="eam-content">
                    <Tabs
                        ...
                        activeKey={pageName}
                    >
                        <TabPane forceRender={true} tab={<span><Icon style={{margin: 0}} type="check-circle-o" /> 预防维护</span>} key="prevention_plan_1">
                            <Collapse bordered={false} defaultActiveKey={['1', '2', '3']}>
                                {/* <Panel header={<span className="label">基本信息 <Icon type="caret-down" /></span>} key="1" style={this.customPanelStyle}> */}
                                    ...
                                    />
                                {/* </Panel> */}
                                <Panel header={<span className="label">工单信息 <Icon type="caret-down" /></span>} key="2" style={this.customPanelStyle}>
                                    <NewBForm
                                        data={data}
                                        formValuesArr={this.formValuesArr}
                                        location={location}
                        ...
                        <TabPane forceRender={true} tab={<span><Icon style={{margin: 0}} type="check-circle-o" /> 频率</span>} key="prevention_plan_2">
                            <Collapse bordered={false} defaultActiveKey={['1', '2', '3']}>
                                <Panel header={<span className="label">工单生成信息 <Icon type="caret-down" /> </span> } key="1" style={this.customPanelStyle}>
                                    <Checkbox
                                        checked={checkedState ? checkedState : data.useTargetDate}
                        ...
                        {/* <TabPane tab={<span><Icon style={{margin: 0}} type="check-circle-o" /> 工单记录</span>} key="prevention_plan_3"></TabPane> */}
                    </Tabs>
                </div>
                <SelectAsset
                    multiple
