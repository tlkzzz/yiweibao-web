...
class CheckPlanComponent extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.columns = [
            {
                ...
                render: (text, record, key) => {
                    return (
                        <p><Link className="order-number" activeClassName="active" to="/security/check_plan/check_plan_detail">{text ? text : '-'}</Link></p>
                    )
                }
            },
            {
                ...
                <div>
                    <div className="top-bar clearfix">
                        ...
                        <div className="list-tools-right pull-right">
                            ...
                            <Button type="primary" size="large"><Link activeClassName="active" to="/security/check_plan/check_plan_detail">新建</Link></Button>
                        </div>
                    </div>
...
export default connect(mapStateToProps, buildActionDispatcher)(CheckPlanComponent);
