...
// 获取列表数据
    getList = () => {
        ...
        actions.getEmployee(this.param, (json) => {
...
// 分页事件
   ...
   // 删除二维码管理
    ...
    del = (id) => {
        const { actions } = this.props;
        let param = {ids: id};
          actions.delEmployee(param, (json) => {
            if(json.code==200){
    ...
    jumpToTabPage = () => {
        ...
        //     browserHistory.push(`/main/settings/code/code_detail?add_code=1`);
        // } else {
        ...
        //     localStorage.setItem('code', JSON.stringify(json));
            browserHistory.push(`/main/settings/employee_add`);
        //     this.setState({
        //         rowSelection: null,
        //     })
        // }
 ...
 const columns  = [
            ...
            },
            {
                ...
                title: '联系电话',
                dataIndex: 'tse_mobile',
                key: 'tse_mobile',
                sorter: true,
            },{
                title: '入职时间',
                dataIndex: 'tseAddDate',
                key: 'tseAddDate',
                sorter: true,
            },
            {
                title: '状态',
                dataIndex: 'tse_status',
                key: 'tse_status',
                sorter: true,
                render:val => <span>{this.employee_state(val)}</span>
            },
            {
                title: '操作',
                dataIndex: '4',
                    ...
                    return (
                        <div className="table-icon-group">
                            <Icon  className="icon-right"
                                type="delete"
                                onClick={() => {
                                    this.showConfirm(record.tse_id, record.tse_name)
                                }}
                            />
                        </div>
                    )
        ...
        return (
             ...
             <div className="main-nav clearfix">
                        ...
                        <Link to="/main/settings/employee" activeClassName="active">员工管理</Link>
...
export default connect(mapStateToProps, buildActionDispatcher)(EmployeeComponent);
