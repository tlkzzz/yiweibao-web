        ...
        try {
            switch(record.orderType)
            {
                case "headquartersDaliyTask"://例行工作单
                    browserHistory.push("/headquarters/routine_work_order/routine_work_order_form?from=/task/handle/handle_tab6");;
...
class HandleSixComponent extends React.Component {
	 constructor(props) {
        super(props);
        // 高级筛选选项数据
...
export default connect(mapStateToProps, buildActionDispatcher)(HandleSixComponent);