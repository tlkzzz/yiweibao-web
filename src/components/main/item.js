...
// 获取列表数据
    getList = () => {
        ...
        actions.getItem(this.param, (json) => {
   ...
   // 删除二维码管理
    ...
    jumpToTabPage = (record , isAdd) => {
        ...
        //     localStorage.removeItem("code");
            browserHistory.push(`/main/settings/item_add`);
        // } else {
                    ...
                    return (
                        <div className="table-icon-group">
                            <Icon  className="icon-right"
                                type="delete"
                                onClick={() => {
                                    this.showConfirm(record.tiId, record.tiUplevelName)
                                }}
                            />
                        </div>
                    )
        ...
        return (
             ...
             <div className="main-nav clearfix">
                        ...
                        <Link to="/main/settings/code" >二维码管理</Link>
                          ...
                          <Link to="/main/settings/item" activeClassName="active">故障类型</Link>
