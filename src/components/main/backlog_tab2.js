            ...
            switch (record.orderType) {
                case "repairOrder"://报修工单
                    ...
                    repairactions.repairOrderInformation({id: record.businessKey}, (data) => {
                        ...
                        browserHistory.push(`/matter_repair/repair/${status.path}?from=/task/backlog/backlog_tab2`);
                    });
		                ...
		                <div className="eam-content">
		                	<div className="eam-card eam-task-condition clearfix">
			                    <div className="eam-task-tab-nav">
					                ...
					                <Pagination simple className="task-top-page pull-right" defaultCurrent={taskPageData.currentPage} total={taskPageData.total} onChange={this.pageChange} />
