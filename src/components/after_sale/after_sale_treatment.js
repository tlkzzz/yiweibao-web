//售后待处理订单  after_sale_treatment.js
//
...
class AfterSaleTreatmentComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            tableLoading: false,
  ...
  workOrder_state=(e)=>{
    ...
    getList = () => {
        ...
        this.setState({tableLoading: true});
         ...
         actions.getAfterSaleOrderList(this.param, (json) => {
...
export default connect(mapStateToProps, buildActionDispatcher)(AfterSaleTreatmentComponent);