    ...
    jumpToTabPage = (record) => {
            ...
            switch(record.orderType)
        {
            case "dispatchOrder"://派工单
                ...
                browserHistory.push(`/matter_repair/dispatch/dispatch_${status.path}?from=/task/backlog/backlog_tab4`);
...
class BacklogFoureComponent extends React.Component {
constructor(props) {
        super(props);
...
export default connect(mapStateToProps, buildActionDispatcher)(BacklogFoureComponent);