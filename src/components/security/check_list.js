        ...
        this.columns = [
            {
                ...
                render: (text, record, key) => {
                    return (
                        <p><Link className="order-number" to="/security/check_list/check_list_detail">{text ? text : '-'}</Link></p>
                    )
                }
            },
            {
                ...
                <div>
                    <div className="top-bar clearfix">
                        ...
                        <div className="list-tools-right pull-right">
                            ...
                            <Button type="primary" size="large" ><Link className="order-number" to="/security/check_list/check_list_detail"> 新建</Link></Button>
                        </div>
                    </div>
...
export default connect(mapStateToProps, buildActionDispatcher)(CheckListComponent);
