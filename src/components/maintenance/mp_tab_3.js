...
class MPTabThreeComponent extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.param = {
            ...
            pageNum: 1,
            pageSize: 10,
            maintenancePlanNum: this.localMaintenancePlan && JSON.parse(this.localMaintenancePlan).id,
        }
    }
    // 表格事件-排序
    ...
    getList = () => {
        ...
        actions.workOrderByMPlanNumGetList(this.param, () => {
            this.setState({
                tableLoading: false,
            });
        });
    ...
    render () {
        ...
        const data = state.workOrderByMPlanNumListData;
...
export default connect(mapStateToProps, buildActionDispatcher)(MPTabThreeComponent);
