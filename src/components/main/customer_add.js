...
class CustomerAddFormComponent extends React.Component {
    constructor(props) {
        super(props);
...
const CustomerAddComponent = Form.create()(CustomerAddFormComponent);
...
export default connect(mapStateToProps, buildActionDispatcher)(CustomerAddComponent);
