...
class DataReportComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            treeData,
        ...
        return (
            <div>
                ...
                <div className="eam-content">
                    ...
                    <div style={{background: '#FFFFFF', float: 'left', width: '80%', height: '600px'}}>
...
export default connect(mapStateToProps, buildActionDispatcher)(DataReportComponent);