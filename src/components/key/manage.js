        ...
        this.columns = [
            {
                ...
                render: (text, record, key) => {
                    return (
                        <p><Link className="order-number" activeClassName="active" to="/key/manage/manage_detail">{text ? text : '-'}</Link></p>
                    )
                }
            },
            {
              ...
              <div>
                  <div className="top-bar clearfix">
                      ...
                      <div className="eam-tab-nav">
                          <Link activeClassName="active" to={`/key/manage/manage_detail`}><Icon type="check-circle-o" /> 基本信息</Link>
                          <Link activeClassName="active" to={`/key/manage/manage_detail_2`}><Icon type="check-circle-o" /> 锁信息</Link>
                          <Link activeClassName="active" to={`/key/manage/manage_detail_3`}><Icon type="check-circle-o" /> 关联申请</Link>
                      </div>
                  </div>
                  {children}
              </div>
                ...
                <div>
                    <div className="top-bar clearfix">
                        ...
                        <div className="list-tools-right pull-right">
                            ...
                            <Button type="primary" size="large"><Link activeClassName="active" to="/key/manage/manage_detail">新建</Link></Button>
                        </div>
                    </div>
